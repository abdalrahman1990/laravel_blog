@foreach($post->likes as $like)
    ...
    <button type="button" data-postid="{{$post->id}}"  data-like="{{$like_status}}"  class="like btn {{$like_status}}">Like
    ...
    <button type="button"data-postid="{{$post->id}}" data-like="{{$dislike_status}}" class=" dislike btn {{$dislike_status}}">Dislike
